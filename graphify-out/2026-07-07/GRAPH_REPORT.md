# Graph Report - svelte-playground  (2026-07-07)

## Corpus Check
- 149 files · ~110,055 words
...
- `renameVmTemplate()` --calls--> `createClient()`  [EXTRACTED]
...
Cohesion: 0.25
Nodes (5): ./notification-store.svelte.js, ./ToastNotification.svelte, $app/forms, @sveltejs/kit, ./PxMxTemplateDialog.svelte
...
Cohesion: 0.15
Nodes (12): Architecture, Client-Side (`PxMxWorkloadControls.svelte`), Design Decisions, Enablement Conditions, Error Handling, Feature: Rename Button, Key Dependencies, Related Features (+4 more)
